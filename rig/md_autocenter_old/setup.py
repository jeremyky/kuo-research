...
install_requires = [
    "requests",
    "gymnasium>=0.28",
    "numpy>=1.21.5",  # Loosened requirement
    "matplotlib",
    "pandas",
    "pygame",
    "tqdm",
    ...
    "Pygments",
    "mediapy",
    "pysdl2"  # Added for manual controller support
]
...
gym_requirement = [
    "gym==0.21.0"  # Using a specific version to avoid setup issues
]
...
waymo_requirement = [ # Used for Waymo Open Motion Dataset
    "tensorflow==2.11.0",
    "protobuf>=3.9.2,<3.20",
    "numpy>=1.21.5",  # Loosened requirement
    "waymo-open-dataset-tf-2-11-0>=1.6.1",  # Matches our TF version
    "scenarionet @ git+https://github.com/metadriverse/scenarionet.git"  # Added ScenarioNet
]

viz_requirement = [ # Used for visualization
    "ffmpeg-python>=0.2.0",  # For saving animations
    ...
    "notebook>=7.0.0"       # For Jupyter notebook server
]
...
setup(
    ...
    extras_require={
        ...
        "viz": viz_requirement,
        "all": cuda_requirement + gym_requirement + ros_requirement + waymo_requirement + viz_requirement
    },
