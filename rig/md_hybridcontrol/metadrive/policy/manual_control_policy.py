...
class ManualControlPolicy(EnvInputPolicy):
    ...
    def act(self, agent_id):
       # print("SDC_ID", str(self.engine.data_manager.current_scenario[SD.METADATA][SD.SDC_ID]))
        #print("track_Data",self.engine.data_manager.current_scenario["tracks"])
        self.controller.process_others(takeover_callback=self.toggle_takeover)
        print("manual_control-index")
        try:
