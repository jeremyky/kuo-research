...
class CustomScenarioEnv(BaseEnv):
    @classmethod
    def default_config(cls):
        config = super(CustomScenarioEnv, cls).default_config()
    ...
    def _post_process_config(self, config):
        config = super(CustomScenarioEnv, self)._post_process_config(config)
    ...
    def done_function(self, vehicle_id: str):
        """Modified to NOT end on viehicle leaving road."""
...
class CustomScenarioOnlineEnv(CustomScenarioEnv):
    """
...
class CustomScenarioWaypointEnv(CustomScenarioEnv):
    """
    ...
    @classmethod
    def default_config(cls):
        config = super(CustomScenarioWaypointEnv, cls).default_config()
        config.update(SCENARIO_WAYPOINT_ENV_CONFIG)
        return config

    def _post_process_config(self, config):
        ret = super(CustomScenarioWaypointEnv, self)._post_process_config(config)
