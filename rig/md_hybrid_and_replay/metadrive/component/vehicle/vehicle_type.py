...
class DefaultVehicle(BaseVehicle):
    ...
    path = ('ferra/vehicle.gltf', (1, 1, 1), (0, 0.075, 0.), (0, 90, 0))  # asset path, scale, offset, HPR
...
class XLVehicle(BaseVehicle):
    ...
    path = ('truck/vehicle.gltf', (1, 1, 1), (0, 0.25, 0.04), (0, -1.5708, 0))  # -90 degrees (π/2 rad) backward
...
class LVehicle(BaseVehicle):
    ...
    path = ['lada/vehicle.gltf', (1.1, 1.1, 1.1), (0, -0.27, 0.07), (0, 90, 0)]
...
class MVehicle(BaseVehicle):
    ...
    path = ['130/vehicle.gltf', (1, 1, 1), (0, -0.05, 0.1), (0, 90, 0)]
...
class SVehicle(BaseVehicle):
    ...
    def path(self):
        if self.use_render_pipeline and platform.system() != "Linux":
            ...
            return ['beetle/vehicle.bam', (0.0077, 0.0077, 0.0077), (0.04512, -0.24 - 0.04512, 1.77), (0, 90, 0)]
        else:
            factor = 1
            return ['beetle/vehicle.gltf', (factor, factor, factor), (0, -0.2, 0.03), (0, 90, 0)]
